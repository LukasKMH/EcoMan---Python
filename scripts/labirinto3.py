...
class Labirinto3(object):
    def __init__(self):
        ...
        self.nodes = NodeGroup("assets/mapas/fase3.txt") 
        self.lista_inimigos = []
    ...
    def startGame(self):
        ...
        self.mazesprites = LabirintoSprites("assets/mapas/fase3.txt", "assets/mapas/fase3_rotacao.txt")
        ...
        self.coletaveis = GrupoColetaveis("assets/mapas/fase3.txt")
